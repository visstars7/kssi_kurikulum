...
<li class="kt-menu__item  kt-menu__item--submenu my-1 <?= $activeSide == 'pembagian_kelas' ? 'kt-menu__item--open' : false ?>" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-icon fas fa-chalkboard-teacher" style="margin-left:-3px;"></i><span class="kt-menu__link-text" style="margin-left:3px;">Pembagian Kelas</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
    <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
        <ul class="kt-menu__subnav">
            ...
            <li class="kt-menu__item <?= $activeSide == 'siswa_belum_berkelas' ? 'kt-menu__item--open' : false ?>" aria-haspopup=" true"><a href="dashboards/brand-aside.html" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Siswa belum berkelas</span></a></li>
            <li class="kt-menu__item <?= $activeSide == 'siswa_sudah_berkelas' ? 'kt-menu__item--open' : false ?>" aria-haspopup=" true"><a href="dashboards/navy-header.html" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Siswa sudah berkelas</span></a></li>
        </ul>
    </div>
</li>
<?php $__env->stopSection(); ?><?php /**PATH /opt/lampp/htdocs/kssi_kurikulum/application/modules/Kesiswaan/views/sidebar.blade.php ENDPATH**/ ?>