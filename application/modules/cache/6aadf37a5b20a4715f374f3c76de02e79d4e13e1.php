...
<div class="container-fluid">
    <div class="row mt-5">
        <div class="col-md-12">
            <button class="btn btn-success float-right" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-plus-circle"></i> <strong>Tambah Rpp</strong></button>
        </div>
    </div>
    <div class="row mt-5">
        <div class="col-md-12">
...
<script>
    ...
    $('#table-perpus').DataTable({
        ...
        "ajax": {
            "url": "<?= base_url('Kurikulum/rpp_datatables') ?>",
            "type": "POST"
        },
...
<?php echo $__env->make('Kurikulum.views.kurikulum', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/kssi_kurikulum/application/modules/Kurikulum/views/rpp.blade.php ENDPATH**/ ?>