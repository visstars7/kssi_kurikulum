                ...
                <div class="kt-portlet__body">
                    <div id="kt-widget-slider-13-2" class="kt-slider carousel slide" data-ride="carousel" data-interval="4000">
                        <div class="kt-slider__head">
                            <div class="kt-slider__label">Kegiatan</div>
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active kt-slider__body">
                                <div class="kt-widget-13">
                                    <div class="kt-widget-13__body">
                                        <a class="kt-widget-13__title" href="#">Pak Budi Hartono</a>
                                        <div class="kt-widget-13__desc">
                                            Membuat materi matematika tentang perhitungan bangun datar
                                        </div>
                                    </div>
                            ...
                            <div class="carousel-item kt-slider__body">
                                <div class="kt-widget-13">
                                    <div class="kt-widget-13__body">
                                        <a class="kt-widget-13__title" href="#">Bu Sulistya Ningrum</a>
                                        <div class="kt-widget-13__desc">
                                            Membuat rangkuman tentang sejarah kerajan-kerajaan yang berdiri di tanah Jawa beratus-ratus tahun yang lalu
                                        </div>
                                    </div>
                                    <div class="kt-widget-13__foot">
                                        <div class="kt-widget-13__progress">
                            ...
                            <div class="carousel-item kt-slider__body">
                                <div class="kt-widget-13">
                                    <div class="kt-widget-13__body">
                                        <a class="kt-widget-13__title" href="#">Pak Anton Sutrisno</a>
                                        <div class="kt-widget-13__desc">
                                            Membuat materi tentang hukum-hukum bacaan yang terdapat pada Al-Qur'an
                                        </div>
                                    </div>
                                    <div class="kt-widget-13__foot">
                                        <div class="kt-widget-13__progress">
            ...
            <div class="kt-portlet kt-portlet--height-fluid-half">
                <div class="kt-portlet__head  kt-portlet__head--noborder">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title">Aktifitas</h3>
                    </div>
                ...
                <div class="kt-portlet__body kt-portlet__body--fluid">
                    <div class="kt-widget-21">
                        <div class="kt-widget-21__title">
                            <div class="kt-widget-21__label">8.4K</div>
                            <img src="assets/img/iconbox_bg.png" class="kt-widget-21__bg" alt="bg" />
                        </div>
                                ...
                                <div class="kt-widget-5__item kt-widget-5__item--info">
                                    <div class="kt-widget-5__item-info">
                                        <a href="#" class="kt-widget-5__item-title">
                                            Pendidikan Agama Islam Tugas 4
                                        </a>
                                ...
                                <div class="kt-timeline">
                                    ...
                                    <div class="kt-timeline__item kt-timeline__item--success">
                                        <div class="kt-timeline__item-section">
                                            ...
                                            <span class="kt-timeline__item-datetime">07:40 WIB</span>
                                        </div>
                                        <a href="" class="kt-timeline__item-text">
                                            Pak Budi Hartono memberikan materi matematika tentang perhitungan bangun datar
                                        </a>
                                    ...
                                    <div class="kt-timeline__item kt-timeline__item--danger">
                                        <div class="kt-timeline__item-section">
                                            ...
                                            <span class="kt-timeline__item-datetime">10:20 WIB</span>
                                        </div>
                                        <a href="" class="kt-timeline__item-text">
                                            Anda login ke Sistem Informasi Kurikulum sebagai admin kurikulum
                                        </a>
                                        <div class="kt-timeline__item-info">
                                            Sistem
                                        </div>
                                    ...
                                    <div class="kt-timeline__item kt-timeline__item--brand">
                                        <div class="kt-timeline__item-section">
                                            ...
                                            <span class="kt-timeline__item-datetime">11:05 WIB</span>
                                        </div>
                                        <a href="" class="kt-timeline__item-text">
                                            Rekap pendataan telah dikirimkan ke super admin
                                        </a>
                                        <div class="kt-timeline__item-info">
                                            Admin Kurikulum
                                        </div>
                                    ...
                                    <div class="kt-timeline__item kt-timeline__item--warning">
                                        <div class="kt-timeline__item-section">
                                            ...
                                            <span class="kt-timeline__item-datetime">13:40 WIB</span>
                                        </div>
                                        <a href="" class="kt-timeline__item-text">
                                            Kelas inovatif tentang dunia perkerjaan dimulai
                                        </a>
                                        <div class="kt-timeline__item-info">
                                            Pengurus Osis
                                        </div>
                                    ...
                                    <div class="kt-timeline__item kt-timeline__item--info">
                                        <div class="kt-timeline__item-section">
                                            ...
                                            <span class="kt-timeline__item-datetime">14.03 WIB</span>
                                        </div>
                                        <a href="" class="kt-timeline__item-text">
                                            Bu Sulistya Ningrum membuat materi tentang sejarah kerajan-kerajaan yang berdiri di tanah Jawa beratus-ratus tahun yang lalu
                                        </a>
                                        <div class="kt-timeline__item-info">
                                            Sejarah Indonesia
                                        </div>
                                    ...
                                    <div class="kt-timeline__item kt-timeline__item--accent">
                                        <div class="kt-timeline__item-section">
                                            ...
                                            <span class="kt-timeline__item-datetime">15:00 WIB</span>
                                        </div>
                                        <a href="" class="kt-timeline__item-text">
                                            Bel sekolah berbunyi tanda pulang sekolah
                                        </a>
                                        <div class="kt-timeline__item-info">
                                            Sekolah
                                        </div>
...
<?php echo $__env->make('Perpustakaan.views.perpustakaan', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kssi_kurikulum\application\modules/Perpustakaan/views/dashboard.blade.php ENDPATH**/ ?>