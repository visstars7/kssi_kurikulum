...
<li class="kt-menu__item my-1 <?= $activeSide == 'dudi_prakerin' ? 'kt-menu__item--open' : false ?>" aria-haspopup="true"><a target="_blank" href="<?= base_url('Humas/dudi-prakerin') ?>" class="kt-menu__link "><i class="kt-menu__link-icon fas fa-user-tie"></i><span class="kt-menu__link-text">DUDI / Prakerin</span></a></li>
