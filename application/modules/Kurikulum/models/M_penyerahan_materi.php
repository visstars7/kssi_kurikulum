...
class M_penyerahan_materi extends CI_model
{
    private $master;
    ...
    var $column_order = array(null, null, null, null, null, null, null, 'waktu_penyerahan'); //Sesuaikan dengan field
    var $column_search = array('nama_siswa', 'nama_kelas', 'id_materi_pjj'); //field yang diizin untuk pencarian 
